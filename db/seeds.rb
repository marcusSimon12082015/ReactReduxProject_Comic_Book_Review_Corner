...
#Creating Comics
xmenComic = Comic.create(title:'Less-Men #1',description:'He is nothing more than incredible',
  release_date:'15-08-2018',publisher: marvel,price:15.0,pages:20,rating:7,
  comic_cover_image: Pathname.new(Rails.root.join("db/images/comic_book_cover_1.jpg")).open);
batmanComic = Comic.create(title:'Beatman #1',description:'Be the Beatman, see the Bateman',release_date:'09-12-2018',publisher: dc,
  price:20.0,pages:25,rating:6,
  comic_cover_image: Pathname.new(Rails.root.join("db/images/comic_book_cover_2.jpg")).open);
supermanComic = Comic.create(title:'Silent Man #1',description:'He works in silence',release_date:'06-08-2018',publisher: dc,
  price:15.0,pages:20,rating:5,
  comic_cover_image: Pathname.new(Rails.root.join("db/images/comic_book_cover_3.jpg")).open);
ghostStories = Comic.create(title:'Ghost Stories #3',description:'Ghost are on the way',release_date:'15-05-2018',
  publisher: tommorow,price:15.0,pages:30,rating:8,
  comic_cover_image: Pathname.new(Rails.root.join("db/images/comic_book_cover_4.jpg")).open);
